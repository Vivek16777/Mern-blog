...
const Signin = () => {
  ...
  return (
    <div className="flex flex-1 justify-center align-middle background-gray-100 mt-20 mb-20">
      <div className='flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-5 background-color-black-transparent'>
        ...
        <span className="px-2 py-1 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-lg text-white mt-3">Note's</span>
      ...
      <div className="flex-1">
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            <div>
              ...
              <TextInput type="email" placeholder="name@company.com" id='email' autoComplete="email" value={formData.email} onChange={handleChange}/>
            </div>
            <div>
              <Label>your password</Label>
              <TextInput type="password" placeholder="********" id='password' autoComplete='new-password' value={formData.password} onChange={handleChange}/>
            </div>
